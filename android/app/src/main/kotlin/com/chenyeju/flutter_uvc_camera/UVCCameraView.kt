...
internal class UVCCameraView(
    ...
    private val mChannel: MethodChannel, params: Any?) : PlatformView, ICameraStateCallBack {
    ...
    fun initCamera(arguments: Any?){
        ...
        handleTextureView(cameraView) // 处理 TextureView
...
setButtonCallback()
    ...
    fun callFlutter(msg: String?) {
        mChannel.invokeMethod("callFlutter", msg)
    }
    ...
    fun getAllPreviewSize(aspectRatio: Double? = null) {
        val list = getCurrentCamera()?.getAllPreviewSizes(aspectRatio)
        mChannel.invokeMethod("getAllPreviewSizes", list.toString())
    }
