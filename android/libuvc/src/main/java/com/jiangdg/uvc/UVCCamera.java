...
//			long id_camera, int venderId, int productId, int fileDescriptor, int busNum, int devAddr, String usbfs
	...
	public int nativeXuRead(int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfbyte) {
		return (this.mCtrlBlock != null) ? native_xu_read(this.mNativePtr, paramInt1, paramInt2, paramInt3, paramArrayOfbyte) : -1;
	}

	public int nativeXuWrite(int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfbyte) {
		return (this.mCtrlBlock != null) ? native_xu_write(this.mNativePtr, paramInt1, paramInt2, paramInt3, paramArrayOfbyte) : -1;
	}
...
//**********************************************************************
	...
	private static final native int native_xu_read(long paramLong, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfbyte);

	private static final native int native_xu_write(long paramLong, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfbyte);
